...
public class GamePlayerListener extends PlayerListener {
    ...
    public void onPlayerQuit(PlayerQuitEvent event) {
        ...
        if(instance.quitMessage.enabled) {
            ...
            args.put("curPlayers", -1);
            if (instance.playerWebhookJoinLeave)
                DiscordPlugin.sendOut(name, getImageFromCfg(name), msgToUsefulOut(player, instance.quitMessage.msg, args, null));
            else
                sendOut(msgToUsefulOut(player, instance.quitMessage.msg, args, null));
        }
    }
}
